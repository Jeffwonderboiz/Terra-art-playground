...
Shader "Davis3D/AlienPlants_Vol3/Enviroment/Nebula"
{
	Properties
	{
		...
		_Flowmap_Intensity("Flowmap_Intensity", Float) = 0.015
		_Wave1_Scale("Wave1_Scale", Float) = 1
		_Wave1_Speed("Wave1_Speed", Float) = 0.7
		_Wave2_Scale("Wave2_Scale", Float) = 2
		_Wave2_Speed("Wave2_Speed", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float2 panner17 = ( _Wave1_Speed * float2( 0.01,-0.01 ) + ( texCoord11 * _Wave1_Scale ));
				float temp_output_2_0_g4 = ( _TimeParameters.x * _Wave2_Speed );
				float2 panner18 = ( temp_output_2_0_g4 * float2( -0.01,0.05 ) + ( texCoord11 * _Wave2_Scale ));
				float2 lerpResult10 = lerp( texCoord11 , (( tex2D( _WaveTexture, panner17 ) + tex2D( _WaveTexture, panner18 ) )).rg , _Flowmap_Intensity);
				float4 tex2DNode1 = tex2D( _Diffuse, lerpResult10 );
				float4 temp_output_27_0 = CalculateContrast(_Contrast,( _Color * tex2DNode1 ));
				
				float3 hdEmission36 = ASEGetEmissionHDRColor(temp_output_27_0.rgb,_GlowIntensity,0.0,GetInverseCurrentExposureMultiplier());
				
				surfaceDescription.Color = temp_output_27_0.rgb;
				surfaceDescription.Emission = hdEmission36;
				surfaceDescription.Alpha = ( tex2DNode1.a * _Opacity );
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord11 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner17 = ( _Wave1_Speed * float2( 0.01,-0.01 ) + ( texCoord11 * _Wave1_Scale ));
				float temp_output_2_0_g4 = ( _TimeParameters.x * _Wave2_Speed );
				float2 panner18 = ( temp_output_2_0_g4 * float2( -0.01,0.05 ) + ( texCoord11 * _Wave2_Scale ));
				float2 lerpResult10 = lerp( texCoord11 , (( tex2D( _WaveTexture, panner17 ) + tex2D( _WaveTexture, panner18 ) )).rg , _Flowmap_Intensity);
...
/*ASEBEGIN
Version=19200
Node;AmplifyShaderEditor.RangedFloatNode;24;-2339.05,310.6381;Inherit;False;Property;_Wave2_Speed;Wave2_Speed;7;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-2233.531,232.4609;Inherit;False;Property;_Wave2_Scale;Wave2_Scale;6;0;Create;True;0;0;0;False;0;False;2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-2241.752,43.69269;Inherit;False;Property;_Wave1_Scale;Wave1_Scale;4;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;11;-2543.248,-175.1821;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-2066.589,212.4606;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-2088.485,110.1895;Inherit;False;Property;_Wave1_Speed;Wave1_Speed;5;0;Create;True;0;0;0;False;0;False;0.7;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-2055.165,22.97504;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;23;-2177.485,302.8067;Inherit;False;TimeWithSpeedVariable;-1;;4;6c6258ddca69992488e84eb5db994d7b;0;1;3;FLOAT;0;False;2;FLOAT;0;FLOAT;5
Node;AmplifyShaderEditor.PannerNode;18;-1926.616,212.6057;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;-0.01,0.05;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;17;-1924.76,23.69246;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0.01,-0.01;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;16;-1750.568,182.6922;Inherit;True;Property;_TextureSample0;Texture Sample 0;10;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;15;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;15;-1752.101,-5.772562;Inherit;True;Property;_WaveTexture;WaveTexture;10;0;Create;True;0;0;0;False;0;False;-1;abc00000000005186804306719253715;abc00000000005186804306719253715;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;13;-1422.951,86.536;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-1300.582,152.0365;Inherit;False;Property;_Flowmap_Intensity;Flowmap_Intensity;3;0;Create;True;0;0;0;False;0;False;0.015;0.015;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;14;-1292.774,81.18513;Inherit;False;True;True;False;False;1;0;COLOR;0,0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.LerpOp;10;-1091.426,55.26589;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ColorNode;9;-897.808,-146.4889;Inherit;False;Property;_Color;Color;8;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-944.152,25.97462;Inherit;True;Property;_Diffuse;Diffuse;9;0;Create;True;0;0;0;False;0;False;-1;abc00000000006085887703447669439;abc00000000006085887703447669439;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;6;-647.6382,-19.28201;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;28;315,31;Float;False;True;-1;2;Rendering.HighDefinition.HDUnlitGUI;0;13;Davis3D/AlienPlants_Vol3/Enviroment/Nebula;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;True;1;0;True;_SrcBlend;0;True;_DstBlend;1;0;True;_AlphaSrcBlend;0;True;_AlphaDstBlend;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullModeForward;False;False;False;True;True;True;True;True;0;True;_ColorMaskTransparentVel;False;False;False;False;False;True;True;0;True;_StencilRef;255;False;;255;True;_StencilWriteMask;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;0;True;_ZWrite;True;0;True;_ZTestDepthEqualForOpaque;False;True;1;LightMode=ForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;30;Surface Type;0;638296473871272830;  Rendering Pass ;0;0;  Rendering Pass;1;0;  Blending Mode;2;638296473632914743;  Receive Fog;0;638296470441668975;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Only;1;0;  Depth Write;1;0;  Cull Mode;0;0;  Depth Test;4;0;Double-Sided;0;0;Alpha Clipping;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Shadow Matte;0;0;Cast Shadows;1;0;DOTS Instancing;0;0;GPU Instancing;1;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;LOD CrossFade;0;0;0;8;True;True;True;True;True;True;False;True;False;;False;0
Node;AmplifyShaderEditor.HDEmissionNode;36;-7.015869,-72.44388;Inherit;False;Luminance;False;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleContrastOpNode;27;-298.0792,-70.34619;Inherit;False;2;1;COLOR;0,0,0,0;False;0;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;37;-175.0791,61.65381;Inherit;False;Property;_GlowIntensity;GlowIntensity;2;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;38;-527.079,184.6538;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;7;-366.4023,41.7294;Inherit;False;Property;_Contrast;Contrast;0;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-649.079,271.6538;Inherit;False;Property;_Opacity;Opacity;1;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=A14591683BCA2C91DD1DDCCF1FD823375AE8C39C