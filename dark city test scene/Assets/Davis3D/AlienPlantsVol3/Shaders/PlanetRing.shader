...
Shader "Davis3D/AlienPlants_Vol3/Enviroment/PlanetRing"
{
	Properties
	{
		...
		_Opacity_Intensity("Opacity_Intensity", Float) = 5
		_Shadow("Shadow", 2D) = "white" {}
		_Shadow_Subtract("Shadow_Subtract", Float) = 0
		_Shadow_Width("Shadow_Width", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _Desaturation;
			float _Shadow_Width;
			float _Shadow_Subtract;
			float _Glow;
			float _Opacity_Intensity;
					...
					)
			{
				...
				float3 temp_output_3_0_g1 = tex2D( _Diffuse, uv_Diffuse ).rgb;
				float3 rotatedValue2_g1 = RotateAroundAxis( temp_cast_1, temp_output_3_0_g1, normalizeResult6_g1.rgb, _Hue );
				float3 desaturateInitialColor12 = ( ( rotatedValue2_g1 + temp_output_3_0_g1 ) * _Brightness );
				...
				float2 texCoord9 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult10 = (float2(texCoord9.x , ( texCoord9.y / _Shadow_Width )));
				float4 temp_cast_3 = (_Shadow_Subtract).xxxx;
				float4 clampResult3 = clamp( ( tex2D( _Shadow, appendResult10 ) - temp_cast_3 ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float3 lerpResult1 = lerp( desaturateVar12 , float3( 0,0,0 ) , clampResult3.rgb);
				
				float3 lerpResult2 = lerp( desaturateVar12 , float3( 0,0,0 ) , clampResult3.rgb);
				float3 hdEmission31 = ASEGetEmissionHDRColor(lerpResult2,_Glow,0.0,GetInverseCurrentExposureMultiplier());
				
				float2 uv_Opacity = packedInput.ase_texcoord1.xy * _Opacity_ST.xy + _Opacity_ST.zw;
				
				surfaceDescription.Color = lerpResult1;
				surfaceDescription.Emission = hdEmission31;
				surfaceDescription.Alpha = ( _Opacity_Intensity * tex2D( _Opacity, uv_Opacity ).g );
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_Opacity = packedInput.ase_texcoord.xy * _Opacity_ST.xy + _Opacity_ST.zw;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float desaturateDot12 = dot( desaturateInitialColor12, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar12 = lerp( desaturateInitialColor12, desaturateDot12.xxx, _Desaturation );
				float2 texCoord9 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult10 = (float2(texCoord9.x , ( texCoord9.y / _Shadow_Width )));
				float4 temp_cast_3 = (_Shadow_Subtract).xxxx;
				float4 clampResult3 = clamp( ( tex2D( _Shadow, appendResult10 ) - temp_cast_3 ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float3 lerpResult1 = lerp( desaturateVar12 , float3( 0,0,0 ) , clampResult3.rgb);
				...
				float2 uv_Opacity = packedInput.ase_texcoord2.xy * _Opacity_ST.xy + _Opacity_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_Opacity = packedInput.ase_texcoord3.xy * _Opacity_ST.xy + _Opacity_ST.zw;
...
/*ASEBEGIN
Version=19200
Node;AmplifyShaderEditor.RangedFloatNode;7;-1456.883,-81.62775;Inherit;False;Property;_Shadow_Width;Shadow_Width;9;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;8;-1271.883,-159.6277;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;19;-1675.235,140.8842;Inherit;True;Property;_Diffuse;Diffuse;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;18;-1511.235,68.88422;Inherit;False;Property;_Hue;Hue;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;10;-1145.883,-212.6277;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-1220.744,229.438;Inherit;False;Property;_Brightness;Brightness;2;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;17;-1372.161,119.1968;Inherit;False;HueShift;-1;;1;3748b6194161e1143a6905ade0b83f9a;0;2;1;FLOAT;0;False;3;FLOAT3;0,1,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-1031.744,270.438;Inherit;False;Property;_Desaturation;Desaturation;3;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-1046.744,156.438;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;6;-976.8832,-203.6277;Inherit;True;Property;_Shadow;Shadow;7;0;Create;True;0;0;0;False;0;False;-1;abc00000000008004390551785253589;abc00000000008004390551785253589;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;5;-876.8832,35.37225;Inherit;False;Property;_Shadow_Subtract;Shadow_Subtract;8;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;4;-646.8832,-58.62775;Inherit;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.DesaturateOpNode;12;-858.7661,166.4105;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-698.1735,452.1904;Inherit;False;Property;_Opacity_Intensity;Opacity_Intensity;6;0;Create;True;0;0;0;False;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;3;-497.8832,-56.62775;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;22;-792.0006,537.8441;Inherit;True;Property;_Opacity;Opacity;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;-486.6275,512.6482;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;1;-242.8832,-53.62775;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;2;-242.8832,59.37225;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=2FD5B4BFF6C42BD8733F98D0AC8012BE1BE66149