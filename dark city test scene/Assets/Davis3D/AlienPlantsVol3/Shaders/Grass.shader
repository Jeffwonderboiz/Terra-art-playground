...
Shader "Davis3D/AlienPlants_Vol3/Nature/Grass"
{
	Properties
	{
		...
		_Norm_Amount("Norm_Amount", Float) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 appendResult13_g1257 = (float3(_0101.x , _0101.y , _0101.z));
				float3 normalizeResult14_g1257 = normalize( appendResult13_g1257 );
				float3 temp_cast_0 = (3.0).xxx;
				float temp_output_19_0_g1257 = ( _0101.w * ( ( _TimeParameters.x * _Wind_Speed ) * -0.5 ) );
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				float3 temp_output_45_0_g1257 = abs( ( ( frac( ( ( ( normalizeResult14_g1257 * temp_output_19_0_g1257 ) + ( ase_worldPos / 10.24 ) ) + 0.5 ) ) * 2.0 ) + -1.0 ) );
				float dotResult58_g1257 = dot( normalizeResult14_g1257 , ( ( ( temp_cast_0 - ( temp_output_45_0_g1257 * 2.0 ) ) * temp_output_45_0_g1257 ) * temp_output_45_0_g1257 ) );
				float3 temp_cast_1 = (3.0).xxx;
				float3 temp_output_46_0_g1257 = abs( ( ( frac( ( ( temp_output_19_0_g1257 + ( ase_worldPos / 2.0 ) ) + 0.5 ) ) * 2.0 ) + -1.0 ) );
				float3 temp_cast_2 = (0.0).xxx;
				float3 temp_cast_3 = (0.0).xxx;
				float3 temp_output_8_0_g1257 = temp_cast_3;
				float3 rotatedValue6_g1257 = RotateAroundAxis( ( float3(0,0,-10) + temp_output_8_0_g1257 ), temp_output_8_0_g1257, cross( normalizeResult14_g1257 , float3(0,0,1) ), ( dotResult58_g1257 + distance( ( ( ( temp_cast_1 - ( temp_output_46_0_g1257 * 2.0 ) ) * temp_output_46_0_g1257 ) * temp_output_46_0_g1257 ) , temp_cast_2 ) ) );
				float2 uv_WindMask = inputMesh.ase_texcoord.xy * _WindMask_ST.xy + _WindMask_ST.zw;
				float3 lerpResult116 = lerp( float3( 0,0,0 ) , ( ( ( rotatedValue6_g1257 * _Wind_Weight ) * _Wind_Intensity ) + temp_output_8_0_g1257 ) , tex2Dlod( _WindMask, float4( uv_WindMask, 0, 0.0) ).g);
				#ifdef _WIND_ON
				...
				float3 customSurfaceDepth291 = inputMesh.positionOS;
				float customEye291 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth291)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord5.z = customEye291;
						...
						)
			{
				...
				float4 color5_g1223 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 normalizeResult6_g1223 = normalize( color5_g1223 );
				...
				float4 localWorldVar14 = float4( 0,0,0,1 );
				(localWorldVar14).xyz = GetCameraRelativePositionWS((localWorldVar14).xyz);
				float4 transform14 = mul(GetWorldToObjectMatrix(),localWorldVar14);
				float2 appendResult16 = (float2(transform14.x , transform14.z));
				float dotResult4_g1221 = dot( appendResult16 , float2( 12.9898,78.233 ) );
				float lerpResult10_g1221 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g1221 ) * 43758.55 ) ));
				float3 temp_cast_3 = (0.0).xxx;
				float2 uv_MainTex = packedInput.ase_texcoord5.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float3 temp_output_3_0_g1222 = tex2D( _MainTex, uv_MainTex ).rgb;
				float3 rotatedValue2_g1222 = RotateAroundAxis( temp_cast_3, temp_output_3_0_g1222, normalizeResult6_g1222.rgb, ( lerpResult10_g1221 * _Dif_Hue_Variation ) );
				float3 temp_output_3_0_g1223 = ( rotatedValue2_g1222 + temp_output_3_0_g1222 );
				float3 rotatedValue2_g1223 = RotateAroundAxis( temp_cast_1, temp_output_3_0_g1223, normalizeResult6_g1223.rgb, _HueShift );
				float3 desaturateInitialColor12 = ( float4( ( rotatedValue2_g1223 + temp_output_3_0_g1223 ) , 0.0 ) * _Diffuse_Multiply ).rgb;
				...
				float3 unpack1 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), _Norm_Amount );
				unpack1.z = lerp( 1, unpack1.z, saturate(_Norm_Amount) );
				
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float3 break50_g1251 = ase_worldPos;
				float2 appendResult14_g1251 = (float2(break50_g1251.x , break50_g1251.y));
				float2 break5_g1252 = appendResult14_g1251;
				float temp_output_11_0_g1252 = _GlowWaveSpeed;
				float2 appendResult1_g1252 = (float2(( break5_g1252.x + ( _TimeParameters.x * ( temp_output_11_0_g1252 * _GlowWave_1_Speed_X ) ) ) , ( break5_g1252.y + ( _TimeParameters.x * ( temp_output_11_0_g1252 * _GlowWave_1_Speed_Y ) ) )));
				float3 appendResult8_g1251 = (float3(appendResult1_g1252 , break50_g1251.z));
				float3 temp_cast_7 = (( ( 1.0 / _GlowWave_1_Scale ) * _Glow_MASTER_SCALE )).xxx;
				float3 temp_output_3_0_g1253 = ( appendResult8_g1251 / -abs( temp_cast_7 ) );
				float4 tex2DNode16_g1253 = tex2D( _GlowWave, (temp_output_3_0_g1253).xz );
				float3 break50_g1227 = ase_worldPos;
				float2 appendResult14_g1227 = (float2(break50_g1227.x , break50_g1227.y));
				float2 break5_g1228 = appendResult14_g1227;
				float temp_output_11_0_g1228 = _GlowWaveSpeed;
				float2 appendResult1_g1228 = (float2(( break5_g1228.x + ( _TimeParameters.x * ( temp_output_11_0_g1228 * _GlowWave_2_Speed_X ) ) ) , ( break5_g1228.y + ( _TimeParameters.x * ( temp_output_11_0_g1228 * _GlowWave_2_Speed_Y ) ) )));
				float3 appendResult8_g1227 = (float3(appendResult1_g1228 , break50_g1227.z));
				float3 temp_cast_8 = (( ( 1.0 / _GlowWave_2_Scale ) * _Glow_MASTER_SCALE )).xxx;
				float3 temp_output_3_0_g1229 = ( appendResult8_g1227 / -abs( temp_cast_8 ) );
				float4 tex2DNode16_g1229 = tex2D( _GlowWave, (temp_output_3_0_g1229).xz );
				float3 break50_g1239 = ase_worldPos;
				float2 appendResult14_g1239 = (float2(break50_g1239.x , break50_g1239.y));
				float2 break5_g1240 = appendResult14_g1239;
				float temp_output_11_0_g1240 = _GlowWaveSpeed;
				float2 appendResult1_g1240 = (float2(( break5_g1240.x + ( _TimeParameters.x * ( temp_output_11_0_g1240 * _GlowWave_3_Speed_X ) ) ) , ( break5_g1240.y + ( _TimeParameters.x * ( temp_output_11_0_g1240 * _GlowWave_3_Speed_Y ) ) )));
				float3 appendResult8_g1239 = (float3(appendResult1_g1240 , break50_g1239.z));
				float3 temp_cast_9 = (( ( 1.0 / _GlowWave_3_Scale ) * _Glow_MASTER_SCALE )).xxx;
				float3 temp_output_3_0_g1241 = ( appendResult8_g1239 / -abs( temp_cast_9 ) );
				float4 tex2DNode16_g1241 = tex2D( _GlowWave, (temp_output_3_0_g1241).xz );
				float3 break50_g1233 = ase_worldPos;
				float2 appendResult14_g1233 = (float2(break50_g1233.x , break50_g1233.y));
				float2 break5_g1234 = appendResult14_g1233;
				float temp_output_11_0_g1234 = _GlowWaveSpeed;
				float2 appendResult1_g1234 = (float2(( break5_g1234.x + ( _TimeParameters.x * ( temp_output_11_0_g1234 * _GlowWave_4_Speed_X ) ) ) , ( break5_g1234.y + ( _TimeParameters.x * ( temp_output_11_0_g1234 * _GlowWave_4_Speed_Y ) ) )));
				float3 appendResult8_g1233 = (float3(appendResult1_g1234 , break50_g1233.z));
				float3 temp_cast_10 = (( ( 1.0 / _GlowWave_4_Scale ) * _Glow_MASTER_SCALE )).xxx;
				float3 temp_output_3_0_g1235 = ( appendResult8_g1233 / -abs( temp_cast_10 ) );
				float4 tex2DNode16_g1235 = tex2D( _GlowWave, (temp_output_3_0_g1235).xz );
				float3 break50_g1245 = ase_worldPos;
				float2 appendResult14_g1245 = (float2(break50_g1245.x , break50_g1245.y));
				float2 break5_g1246 = appendResult14_g1245;
				float temp_output_11_0_g1246 = _GlowWaveSpeed;
				float2 appendResult1_g1246 = (float2(( break5_g1246.x + ( _TimeParameters.x * ( temp_output_11_0_g1246 * _GlowWave_5_Speed_X ) ) ) , ( break5_g1246.y + ( _TimeParameters.x * ( temp_output_11_0_g1246 * _GlowWave_5_Speed_Y ) ) )));
				float3 appendResult8_g1245 = (float3(appendResult1_g1246 , break50_g1245.z));
				float3 temp_cast_11 = (( ( 1.0 / _GlowWave_5_Scale ) * _Glow_MASTER_SCALE )).xxx;
				float3 temp_output_3_0_g1247 = ( appendResult8_g1245 / -abs( temp_cast_11 ) );
				float4 tex2DNode16_g1247 = tex2D( _GlowWave, (temp_output_3_0_g1247).xz );
				float clampResult59 = clamp( ( ( ( (tex2DNode16_g1253).r * (tex2DNode16_g1229).r ) + (tex2DNode16_g1241).r ) * ( (tex2DNode16_g1235).r + (tex2DNode16_g1247).r ) ) , _Glow_Min_Amount , 1.0 );
				...
				float4 color5_g1224 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 normalizeResult6_g1224 = normalize( color5_g1224 );
				float3 temp_cast_13 = (0.0).xxx;
				float3 temp_output_3_0_g1224 = _GlowColor.rgb;
				float3 rotatedValue2_g1224 = RotateAroundAxis( temp_cast_13, temp_output_3_0_g1224, normalizeResult6_g1224.rgb, _HueShift );
				float3 desaturateInitialColor71 = ( rotatedValue2_g1224 + temp_output_3_0_g1224 );
				...
				float3 hdEmission327 = ASEGetEmissionHDRColor(( float4( ( GlowWave306 * desaturateVar71 ) , 0.0 ) * tex2D( _Glow, uv_Glow ) ).rgb,_Glow_Amount,0.0,GetInverseCurrentExposureMultiplier());
				...
				float dither290 = Dither4x4Bayer( fmod(clipScreen290.x, 4), fmod(clipScreen290.y, 4) );
				float customEye291 = packedInput.ase_texcoord5.z;
				...
				surfaceDescription.BaseColor = ( desaturateVar12 * _Diffuse_Brightness );
				surfaceDescription.Normal = unpack1;
				...
				surfaceDescription.Emission = hdEmission327;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float3 temp_output_8_0_g1257 = temp_cast_3;
				float3 rotatedValue6_g1257 = RotateAroundAxis( ( float3(0,0,-10) + temp_output_8_0_g1257 ), temp_output_8_0_g1257, cross( normalizeResult14_g1257 , float3(0,0,1) ), ( dotResult58_g1257 + distance( ( ( ( temp_cast_1 - ( temp_output_46_0_g1257 * 2.0 ) ) * temp_output_46_0_g1257 ) * temp_output_46_0_g1257 ) , temp_cast_2 ) ) );
				float2 uv_WindMask = inputMesh.uv0.xy * _WindMask_ST.xy + _WindMask_ST.zw;
				float3 lerpResult116 = lerp( float3( 0,0,0 ) , ( ( ( rotatedValue6_g1257 * _Wind_Weight ) * _Wind_Intensity ) + temp_output_8_0_g1257 ) , tex2Dlod( _WindMask, float4( uv_WindMask, 0, 0.0) ).g);
				#ifdef _WIND_ON
				float3 staticSwitch309 = lerpResult116;
				#else
				...
				float3 customSurfaceDepth291 = inputMesh.positionOS;
				float customEye291 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth291)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord2.z = customEye291;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 clipScreen290 = ase_screenPosNorm.xy * _ScreenParams.xy;
				float dither290 = Dither4x4Bayer( fmod(clipScreen290.x, 4), fmod(clipScreen290.y, 4) );
				float customEye291 = packedInput.ase_texcoord2.z;
				float cameraDepthFade291 = (( customEye291 -_ProjectionParams.y - _LODDitheringOffset ) / _LODDitheringLength);
				float clampResult296 = clamp( cameraDepthFade291 , 0.0 , 1.0 );
				dither290 = step( dither290, ( 1.0 - clampResult296 ) );
				float LODAlpha292 = dither290;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 customSurfaceDepth291 = inputMesh.positionOS;
				float customEye291 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth291)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord2.x = customEye291;
				
				
				//setting value to unused interpolator channels and avoid initialization warnings
				outputPackedVaryingsMeshToPS.ase_texcoord2.yzw = 0;
					...
					)
			{
				...
				float2 clipScreen290 = ase_screenPosNorm.xy * _ScreenParams.xy;
				float dither290 = Dither4x4Bayer( fmod(clipScreen290.x, 4), fmod(clipScreen290.y, 4) );
				float customEye291 = packedInput.ase_texcoord2.x;
				float cameraDepthFade291 = (( customEye291 -_ProjectionParams.y - _LODDitheringOffset ) / _LODDitheringLength);
				float clampResult296 = clamp( cameraDepthFade291 , 0.0 , 1.0 );
				dither290 = step( dither290, ( 1.0 - clampResult296 ) );
				float LODAlpha292 = dither290;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 customSurfaceDepth291 = inputMesh.positionOS;
				float customEye291 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth291)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord3.z = customEye291;
					...
					)
			{
				...
				float2 clipScreen290 = ase_screenPosNorm.xy * _ScreenParams.xy;
				float dither290 = Dither4x4Bayer( fmod(clipScreen290.x, 4), fmod(clipScreen290.y, 4) );
				float customEye291 = packedInput.ase_texcoord3.z;
				float cameraDepthFade291 = (( customEye291 -_ProjectionParams.y - _LODDitheringOffset ) / _LODDitheringLength);
				float clampResult296 = clamp( cameraDepthFade291 , 0.0 , 1.0 );
				dither290 = step( dither290, ( 1.0 - clampResult296 ) );
				float LODAlpha292 = dither290;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float3 customSurfaceDepth291 = inputMesh.positionOS;
				float customEye291 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth291)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord7.z = customEye291;
						...
						)
			{
				...
				float2 clipScreen290 = ase_screenPosNorm.xy * _ScreenParams.xy;
				float dither290 = Dither4x4Bayer( fmod(clipScreen290.x, 4), fmod(clipScreen290.y, 4) );
				float customEye291 = packedInput.ase_texcoord7.z;
				float cameraDepthFade291 = (( customEye291 -_ProjectionParams.y - _LODDitheringOffset ) / _LODDitheringLength);
				float clampResult296 = clamp( cameraDepthFade291 , 0.0 , 1.0 );
				dither290 = step( dither290, ( 1.0 - clampResult296 ) );
				float LODAlpha292 = dither290;
		...
		Pass
        {
					...
					)
			{
				...
				float2 clipScreen290 = ase_screenPosNorm.xy * _ScreenParams.xy;
				float dither290 = Dither4x4Bayer( fmod(clipScreen290.x, 4), fmod(clipScreen290.y, 4) );
				float customEye291 = packedInput.ase_texcoord3.x;
				float cameraDepthFade291 = (( customEye291 -_ProjectionParams.y - _LODDitheringOffset ) / _LODDitheringLength);
				float clampResult296 = clamp( cameraDepthFade291 , 0.0 , 1.0 );
				dither290 = step( dither290, ( 1.0 - clampResult296 ) );
				float LODAlpha292 = dither290;
...
/*ASEBEGIN
Version=19200
Node;AmplifyShaderEditor.CommentaryNode;301;-4170.201,-21.98611;Inherit;False;2122.272;1141.557;GlowWave;26;310;123;124;121;130;132;125;126;133;135;128;127;129;120;122;306;305;59;307;57;58;56;55;52;117;118;;0,0.8378735,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;18;-1483.25,-449.4389;Inherit;False;Random Range;-1;;1221;7b754edb8aebbfb4a9ace907af661cfc;0;3;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;303;-1326.585,-28.43362;Inherit;False;583.5493;348.0104;Normal;2;1;2;;0,0.3093212,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;302;-1843.539,330.9426;Inherit;False;1110.721;636.5601;Glow;10;73;63;64;65;70;71;72;98;97;308;;1,0,0,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;304;-1611.715,974.1215;Inherit;False;877.0411;460;Wind;7;309;116;114;111;113;112;110;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;2;-1276.585,126.8818;Inherit;False;Property;_Norm_Amount;Norm_Amount;9;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;13;-1166.673,-318.0761;Inherit;False;HueShift;-1;;1222;3748b6194161e1143a6905ade0b83f9a;0;2;1;FLOAT;0;False;3;FLOAT3;0,1,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;9;-861.1299,-365.5845;Inherit;False;HueShift;-1;;1223;3748b6194161e1143a6905ade0b83f9a;0;2;1;FLOAT;0;False;3;FLOAT3;0,1,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;64;-1589.79,573.3107;Inherit;False;HueShift;-1;;1224;3748b6194161e1143a6905ade0b83f9a;0;2;1;FLOAT;0;False;3;FLOAT3;0,1,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-1106.194,78.56268;Inherit;True;Property;_NormalMap;Normal;8;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.DitheringNode;290;-2501.965,1473.277;Inherit;False;0;False;4;0;FLOAT;0;False;1;SAMPLER2D;;False;2;FLOAT4;0,0,0,0;False;3;SAMPLERSTATE;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;295;-213.4285,191.182;Inherit;False;292;LODAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;328;-1342.451,1038.836;Inherit;False;SimpleGrassWind;-1;;1257;2f5588d2087aaab40a4d9a662ffe0ccd;0;4;5;FLOAT;0;False;7;FLOAT;0;False;23;FLOAT;1;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-406.4619,52.6792;Inherit;False;Property;_Metallic;Metallic;5;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
WireConnection;52;0;315;0
WireConnection;52;1;311;0
WireConnection;56;0;52;0
WireConnection;56;1;313;0
WireConnection;55;0;312;0
WireConnection;55;1;314;0
...
WireConnection;72;0;308;0
WireConnection;72;1;71;0
WireConnection;12;0;11;0
WireConnection;12;1;20;0
WireConnection;116;1;328;0
...
WireConnection;311;21;118;0
WireConnection;311;7;121;0
WireConnection;311;11;120;0
WireConnection;311;12;122;0
WireConnection;311;13;117;0
WireConnection;312;21;118;0
WireConnection;312;7;125;0
WireConnection;312;11;133;0
WireConnection;312;12;126;0
WireConnection;312;13;117;0
WireConnection;313;21;118;0
WireConnection;313;7;127;0
WireConnection;313;11;129;0
WireConnection;313;12;128;0
WireConnection;313;13;117;0
WireConnection;314;21;118;0
WireConnection;314;7;135;0
WireConnection;314;11;130;0
WireConnection;314;12;132;0
WireConnection;314;13;117;0
WireConnection;315;21;118;0
WireConnection;315;7;310;0
WireConnection;315;11;123;0
WireConnection;315;12;124;0
WireConnection;315;13;117;0
WireConnection;316;0;6;0
WireConnection;316;1;1;0
WireConnection;316;6;327;0
WireConnection;316;7;23;0
WireConnection;316;9;295;0
WireConnection;316;11;309;0
WireConnection;327;0;97;0
WireConnection;327;1;73;0
WireConnection;328;5;112;0
WireConnection;328;7;113;0
WireConnection;328;23;111;0
WireConnection;328;8;110;0
ASEEND*/
//CHKSM=74CB5BAB57402BE79B9BCCEF07E23F98143B19A6