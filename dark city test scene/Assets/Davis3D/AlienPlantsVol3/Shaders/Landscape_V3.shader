...
Shader "Davis3D/AlienPlants_Vol3/Enviroment/Landscape_V3"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 WorldToAbsoluteWorld3_g717( float3 In )
			{
						...
						)
			{
				...
				float3 appendResult2_g685 = (float3(1.0 , 1.0 , isFrontFace));
				...
				float dotResult12_g685 = dot( V , tangentToWorldDir10_g685 );
				float clampResult13_g685 = clamp( dotResult12_g685 , 0.0 , 1.0 );
				float2 texCoord44 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 In3_g717 = ase_worldPos;
				float3 localWorldToAbsoluteWorld3_g717 = WorldToAbsoluteWorld3_g717( In3_g717 );
				float temp_output_1_0_g686 = 0.0;
				float temp_output_299_0 = saturate( ( ( distance( _WorldSpaceCameraPos , localWorldToAbsoluteWorld3_g717 ) - temp_output_1_0_g686 ) / ( _Macro_Distance - temp_output_1_0_g686 ) ) );
				...
				float3 desaturateInitialColor333 = temp_output_279_0;
				float desaturateDot333 = dot( desaturateInitialColor333, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar333 = lerp( desaturateInitialColor333, desaturateDot333.xxx, 1.0 );
				...
				float DistanceLerp355 = cameraDepthFade306;
				float4 lerpResult329 = lerp( float4( temp_output_279_0 , 0.0 ) , ( ( _DistanceColor * _DistanceBrightness ) * float4( desaturateVar333 , 0.0 ) ) , DistanceLerp355);
				float4 lerpResult330 = lerp( float4( temp_output_279_0 , 0.0 ) , lerpResult329 , _DistanceBrightnessToggle);
				
				float2 texCoord23 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord80 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 break50_g730 = ase_worldPos;
				float2 appendResult14_g730 = (float2(break50_g730.x , break50_g730.y));
				float2 break5_g731 = appendResult14_g730;
				float temp_output_11_0_g731 = _GlowWaveSpeed;
				float2 appendResult1_g731 = (float2(( break5_g731.x + ( _TimeParameters.x * ( temp_output_11_0_g731 * _GlowWave_1_Speed_X ) ) ) , ( break5_g731.y + ( _TimeParameters.x * ( temp_output_11_0_g731 * _GlowWave_1_Speed_Y ) ) )));
				float3 appendResult8_g730 = (float3(appendResult1_g731 , break50_g730.z));
				float3 temp_cast_6 = (( ( 1.0 / _GlowWave_1_Scale ) * _Glow_MASTER_SCALE )).xxx;
				float3 temp_output_3_0_g732 = ( appendResult8_g730 / -abs( temp_cast_6 ) );
				float4 tex2DNode16_g732 = tex2D( _GlowWave, (temp_output_3_0_g732).xz );
				float3 break50_g742 = ase_worldPos;
				float2 appendResult14_g742 = (float2(break50_g742.x , break50_g742.y));
				float2 break5_g743 = appendResult14_g742;
				float temp_output_11_0_g743 = _GlowWaveSpeed;
				float2 appendResult1_g743 = (float2(( break5_g743.x + ( _TimeParameters.x * ( temp_output_11_0_g743 * _GlowWave_2_Speed_X ) ) ) , ( break5_g743.y + ( _TimeParameters.x * ( temp_output_11_0_g743 * _GlowWave_2_Speed_Y ) ) )));
				float3 appendResult8_g742 = (float3(appendResult1_g743 , break50_g742.z));
				float3 temp_cast_7 = (( ( 1.0 / _GlowWave_2_Scale ) * _Glow_MASTER_SCALE )).xxx;
				float3 temp_output_3_0_g744 = ( appendResult8_g742 / -abs( temp_cast_7 ) );
				float4 tex2DNode16_g744 = tex2D( _GlowWave, (temp_output_3_0_g744).xz );
				float3 break50_g724 = ase_worldPos;
				float2 appendResult14_g724 = (float2(break50_g724.x , break50_g724.y));
				float2 break5_g725 = appendResult14_g724;
				float temp_output_11_0_g725 = _GlowWaveSpeed;
				float2 appendResult1_g725 = (float2(( break5_g725.x + ( _TimeParameters.x * ( temp_output_11_0_g725 * _GlowWave_3_Speed_X ) ) ) , ( break5_g725.y + ( _TimeParameters.x * ( temp_output_11_0_g725 * _GlowWave_3_Speed_Y ) ) )));
				float3 appendResult8_g724 = (float3(appendResult1_g725 , break50_g724.z));
				float3 temp_cast_8 = (( ( 1.0 / _GlowWave_3_Scale ) * _Glow_MASTER_SCALE )).xxx;
				float3 temp_output_3_0_g726 = ( appendResult8_g724 / -abs( temp_cast_8 ) );
				float4 tex2DNode16_g726 = tex2D( _GlowWave, (temp_output_3_0_g726).xz );
				float3 break50_g718 = ase_worldPos;
				float2 appendResult14_g718 = (float2(break50_g718.x , break50_g718.y));
				float2 break5_g719 = appendResult14_g718;
				float temp_output_11_0_g719 = _GlowWaveSpeed;
				float2 appendResult1_g719 = (float2(( break5_g719.x + ( _TimeParameters.x * ( temp_output_11_0_g719 * _GlowWave_4_Speed_X ) ) ) , ( break5_g719.y + ( _TimeParameters.x * ( temp_output_11_0_g719 * _GlowWave_4_Speed_Y ) ) )));
				float3 appendResult8_g718 = (float3(appendResult1_g719 , break50_g718.z));
				float3 temp_cast_9 = (( ( 1.0 / _GlowWave_4_Scale ) * _Glow_MASTER_SCALE )).xxx;
				float3 temp_output_3_0_g720 = ( appendResult8_g718 / -abs( temp_cast_9 ) );
				float4 tex2DNode16_g720 = tex2D( _GlowWave, (temp_output_3_0_g720).xz );
				float3 break50_g736 = ase_worldPos;
				float2 appendResult14_g736 = (float2(break50_g736.x , break50_g736.y));
				float2 break5_g737 = appendResult14_g736;
				float temp_output_11_0_g737 = _GlowWaveSpeed;
				float2 appendResult1_g737 = (float2(( break5_g737.x + ( _TimeParameters.x * ( temp_output_11_0_g737 * _GlowWave_5_Speed_X ) ) ) , ( break5_g737.y + ( _TimeParameters.x * ( temp_output_11_0_g737 * _GlowWave_5_Speed_Y ) ) )));
				float3 appendResult8_g736 = (float3(appendResult1_g737 , break50_g736.z));
				float3 temp_cast_10 = (( ( 1.0 / _GlowWave_5_Scale ) * _Glow_MASTER_SCALE )).xxx;
				float3 temp_output_3_0_g738 = ( appendResult8_g736 / -abs( temp_cast_10 ) );
				float4 tex2DNode16_g738 = tex2D( _GlowWave, (temp_output_3_0_g738).xz );
				float3 Dirt_Glow73 = ( lerpResult86 * ( ( ( ( ( (tex2DNode16_g732).r * (tex2DNode16_g744).r ) + (tex2DNode16_g726).r ) * ( (tex2DNode16_g720).r + (tex2DNode16_g738).r ) ) * _GlowColor ) * _Glow_Amount ) ).rgb;
				...
				float3 temp_output_307_0 = ( localMyCustomExpression73 * cameraDepthFade306 );
				float3 hdEmission321 = ASEGetEmissionHDRColor(temp_output_307_0,temp_output_307_0.x,0.0,GetInverseCurrentExposureMultiplier());
				...
				surfaceDescription.BaseColor = lerpResult330.rgb;
				surfaceDescription.Normal = BlendNormal( BlendNormal( UnpackNormalScale( tex2D( _Dirt_A_Norm, temp_output_39_0 ), 1.0f ) , UnpackNormalScale( tex2D( _Dirt_A_Norm, ( temp_output_39_0 * _Dirt_A_Norm2_Scale ) ), 1.0f ) ) , lerpResult3 );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = lerpResult61;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = hdEmission321;
				surfaceDescription.Smoothness = ( 1.0 - lerpResult68 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord6.xy = inputMesh.uv0.xy;
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord44 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_39_0 = ( ( ( float2( 0.001982,0.001982 ) + texCoord44 ) * float2( 1009,1009 ) ) * _Dirt_A_Scale );
		...
		Pass
		{
						...
						)
			{
				...
				float dotResult12_g685 = dot( V , tangentToWorldDir10_g685 );
				float clampResult13_g685 = clamp( dotResult12_g685 , 0.0 , 1.0 );
				float2 texCoord44 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_39_0 = ( ( ( float2( 0.001982,0.001982 ) + texCoord44 ) * float2( 1009,1009 ) ) * _Dirt_A_Scale );
				float lerpResult32 = lerp( _Macro_Multiplier_A , _Macro_Multiplier_B , tex2D( _Macro_Multiplier, ( temp_output_39_0 * _Macro_Multiplier_Scale ) ).g);
				float4 tex2DNode48 = tex2D( _Dirt_A_Dif, temp_output_39_0 );
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				...
				float2 texCoord23 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack12 = UnpackNormalScale( tex2D( _Macro_Norm, ( ( ( texCoord23 + float2( 0.001982,0.001982 ) ) * float2( 1009,1009 ) ) * _Macro_Norm2_Scale ) ), _Macro_Norm_Amount );
				unpack12.z = lerp( 1, unpack12.z, saturate(_Macro_Norm_Amount) );
				float3 lerpResult3 = lerp( float3(0,0,1) , unpack12 , temp_output_299_0);
				...
				float2 texCoord80 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_74_0 = ( texCoord80 * _WeightMapScale );
				float Dirt_GlowWeight73 = tex2D( _Dirt_Glow, temp_output_74_0 ).r;
				float Dirt_PlainWeight73 = tex2D( _Dirt_Plain, temp_output_74_0 ).r;
				float lerpResult86 = lerp( ( tex2DNode48.r * _Glow_Multiplier_Close ) , _Glow_Multiplier_Far , temp_output_299_0);
...
Node;AmplifyShaderEditor.DesaturateOpNode;87;-3900.926,1769.829;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;26;-4125.187,1999.692;Inherit;False;Property;_Desaturation;Desaturation;3;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;91;-3839.843,1215.806;Inherit;False;Property;_Glow_Multiplier_Close;Glow_Multiplier_Close;31;0;Create;True;0;0;0;False;0;False;0.3;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CameraDepthFade;306;-2482.648,1029.027;Inherit;False;3;2;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;308;-2739.041,1065.448;Inherit;False;Property;_Glow_DistanceFade;Glow_DistanceFade;30;0;Create;True;0;0;0;False;0;False;25;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;307;-2214.041,763.4483;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.HDEmissionNode;321;-2060.64,749.8935;Inherit;False;Luminance;False;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WorldPosInputsNode;294;-5150.983,-564.6611;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.FunctionNode;322;-4923.564,-580.5244;Inherit;False;WorldToAbsoluteWorld;-1;;717;6d428b11c6ab4974e8382ebacb8c51f1;0;1;5;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;323;-4723.629,1562.696;Inherit;False;MF_Davis3D_WorldAlignedGlowWave;26;;718;d13e22b35e7408b4ca811f5cb053c474;0;5;21;SAMPLER2D;0;False;7;FLOAT;1;False;11;FLOAT;0;False;12;FLOAT;0;False;13;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;324;-4727.585,1402.856;Inherit;False;MF_Davis3D_WorldAlignedGlowWave;26;;724;d13e22b35e7408b4ca811f5cb053c474;0;5;21;SAMPLER2D;0;False;7;FLOAT;1;False;11;FLOAT;0;False;12;FLOAT;0;False;13;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;325;-4728.625,1065.033;Inherit;False;MF_Davis3D_WorldAlignedGlowWave;26;;730;d13e22b35e7408b4ca811f5cb053c474;0;5;21;SAMPLER2D;0;False;7;FLOAT;1;False;11;FLOAT;0;False;12;FLOAT;0;False;13;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;326;-4718.406,1731.811;Inherit;False;MF_Davis3D_WorldAlignedGlowWave;26;;736;d13e22b35e7408b4ca811f5cb053c474;0;5;21;SAMPLER2D;0;False;7;FLOAT;1;False;11;FLOAT;0;False;12;FLOAT;0;False;13;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;327;-4726.713,1227.962;Inherit;False;MF_Davis3D_WorldAlignedGlowWave;26;;742;d13e22b35e7408b4ca811f5cb053c474;0;5;21;SAMPLER2D;0;False;7;FLOAT;1;False;11;FLOAT;0;False;12;FLOAT;0;False;13;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;329;217.1874,-635.4274;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;330;441.1874,-587.4274;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;331;89.18739,-411.4273;Inherit;False;Property;_DistanceBrightnessToggle;DistanceBrightnessToggle;32;0;Create;True;0;0;0;False;0;False;0;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;332;95.39719,-871.0267;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.DesaturateOpNode;333;-81.60281,-791.0267;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;334;-73.60281,-898.0267;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;335;-290.4776,-828.0803;Inherit;False;Property;_DistanceBrightness;DistanceBrightness;29;0;Create;True;0;0;0;False;0;False;1;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;336;-332.8471,-1036.781;Inherit;False;Property;_DistanceColor;DistanceColor;24;0;Create;True;0;0;0;False;0;False;0.8962264,0.8512375,0.5191349,1;1,0.5098038,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;355;-2235.704,1022.094;Inherit;False;DistanceLerp;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;328;89.18739,-507.4274;Inherit;False;355;DistanceLerp;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;38;-2510.708,-485.8329;Inherit;False;Property;_Macro_Multiplier_Scale;Macro_Multiplier_Scale;54;0;Create;True;0;0;0;False;0;False;0.4;0.01;0;0;0;1;FLOAT;0
...
WireConnection;94;0;323;0
WireConnection;94;1;326;0
WireConnection;93;0;95;0
WireConnection;93;1;324;0
WireConnection;30;0;32;0
WireConnection;30;1;31;0
WireConnection;95;0;325;0
WireConnection;95;1;327;0
...
WireConnection;310;0;330;0
WireConnection;310;1;2;0
WireConnection;310;4;61;0
WireConnection;310;6;321;0
WireConnection;310;7;70;0
WireConnection;307;0;73;0
WireConnection;307;1;306;0
WireConnection;321;0;307;0
WireConnection;321;1;307;0
WireConnection;322;5;294;0
WireConnection;323;21;146;0
WireConnection;323;7;112;0
WireConnection;323;11;117;0
WireConnection;323;12;122;0
WireConnection;323;13;124;0
WireConnection;324;21;146;0
WireConnection;324;7;111;0
WireConnection;324;11;116;0
WireConnection;324;12;121;0
WireConnection;324;13;124;0
WireConnection;325;21;146;0
WireConnection;325;7;109;0
WireConnection;325;11;114;0
WireConnection;325;12;119;0
WireConnection;325;13;124;0
WireConnection;326;21;146;0
WireConnection;326;7;113;0
WireConnection;326;11;118;0
WireConnection;326;12;123;0
WireConnection;326;13;124;0
WireConnection;327;21;146;0
WireConnection;327;7;110;0
WireConnection;327;11;115;0
WireConnection;327;12;120;0
WireConnection;327;13;124;0
WireConnection;329;0;279;0
WireConnection;329;1;332;0
WireConnection;329;2;328;0
WireConnection;330;0;279;0
...
ASEEND*/
//CHKSM=CFE9BB4A7C705705E440F327BB623CA0E850C810