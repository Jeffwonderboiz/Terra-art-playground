	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 temp_output_45_0_g588 = abs( ( ( frac( ( ( ( normalizeResult14_g588 * temp_output_19_0_g588 ) + ( ase_worldPos / 10.24 ) ) + 0.5 ) ) * 2.0 ) + -1.0 ) );
				...
				float3 temp_output_46_0_g588 = abs( ( ( frac( ( ( temp_output_19_0_g588 + ( ase_worldPos / 2.0 ) ) + 0.5 ) ) * 2.0 ) + -1.0 ) );
						...
						)
			{
				...
				float4 localWorldVar43 = float4( 0,0,0,1 );
				(localWorldVar43).xyz = GetCameraRelativePositionWS((localWorldVar43).xyz);
				float4 transform43 = mul(GetWorldToObjectMatrix(),localWorldVar43);
				...
				float lerpResult38 = lerp( 1.0 , 0.0 , saturate( ( ( distance( _WorldSpaceCameraPos , ase_worldPos ) - temp_output_1_0_g585 ) / ( 0.0 - temp_output_1_0_g585 ) ) ));
				float2 texCoord19 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_cast_2 = (tex2D( _Diffuse_Detail, ( texCoord19 * 8.0 ) ).g).xxxx;
				float2 temp_cast_3 = (_Diffuse_Detail_WS_Scale).xx;
				float4 triplanar25 = TriplanarSampling25( _Diffuse_Detail, ase_worldPos, normalWS, 1.0, temp_cast_3, 1.0, 0 );
				...
				float4 appendResult18_g586 = (float4(_Vector1.x , _Vector1.y , isFrontFace , 1.0));
				float3 Binormal8_g587 = ( ( packedInput.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( normalWS , tangentWS.xyz ) );
				float3x3 TBN10_g587 = float3x3(tangentWS.xyz, Binormal8_g587, normalWS);
				float dotResult10_g586 = dot( V , mul( ( float4( float3( 0,0,1 ) , 0.0 ) * appendResult18_g586 ).xyz, TBN10_g587 ) );
				...
				float2 texCoord60 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 break3_g577 = ase_worldPos;
				...
				float2 appendResult1_g579 = (float2(( break5_g579.x + ( _TimeParameters.x * ( temp_output_11_0_g579 * _GlowWave_1_Speed_X ) ) ) , ( break5_g579.y + ( _TimeParameters.x * ( temp_output_11_0_g579 * _GlowWave_1_Speed_Y ) ) )));
				float2 break5_g578 = temp_output_8_0_g577;
				float temp_output_11_0_g578 = _Glow_World_Speed;
				float2 appendResult1_g578 = (float2(( break5_g578.x + ( _TimeParameters.x * ( temp_output_11_0_g578 * _GlowWave_2_Speed_X ) ) ) , ( break5_g578.y + ( _TimeParameters.x * ( temp_output_11_0_g578 * _GlowWave_2_Speed_Y ) ) )));
				float2 break5_g582 = temp_output_8_0_g577;
				float temp_output_11_0_g582 = _Glow_World_Speed;
				float2 appendResult1_g582 = (float2(( break5_g582.x + ( _TimeParameters.x * ( temp_output_11_0_g582 * _GlowWave_3_Speed_X ) ) ) , ( break5_g582.y + ( _TimeParameters.x * ( temp_output_11_0_g582 * _GlowWave_3_Speed_Y ) ) )));
				float2 break5_g581 = temp_output_8_0_g577;
				float temp_output_11_0_g581 = _Glow_World_Speed;
				float2 appendResult1_g581 = (float2(( break5_g581.x + ( _TimeParameters.x * ( temp_output_11_0_g581 * _GlowWave_4_Speed_X ) ) ) , ( break5_g581.y + ( _TimeParameters.x * ( temp_output_11_0_g581 * _GlowWave_4_Speed_Y ) ) )));
				float2 break5_g580 = temp_output_8_0_g577;
				float temp_output_11_0_g580 = _Glow_World_Speed;
				float2 appendResult1_g580 = (float2(( break5_g580.x + ( _TimeParameters.x * ( temp_output_11_0_g580 * _GlowWave_5_Speed_X ) ) ) , ( break5_g580.y + ( _TimeParameters.x * ( temp_output_11_0_g580 * _GlowWave_5_Speed_Y ) ) )));
				float lerpResult104 = lerp( _Glow_Amount , _GlowIntensity_Variation , temp_output_48_0);
				float4 temp_output_99_0 = ( ( tex2DNode72.g * _GlowColor ) * ( ( _Glow_Min_Amount + ( ( ( ( tex2D( _GlowWave, appendResult1_g579 ).g * tex2D( _GlowWave, appendResult1_g578 ).g ) + tex2D( _GlowWave, appendResult1_g582 ).g ) * ( tex2D( _GlowWave, appendResult1_g581 ).g + tex2D( _GlowWave, appendResult1_g580 ).g ) ) + 0.0 ) ) * lerpResult104 ) );
				float4 lerpResult88 = lerp( temp_output_99_0 , ( tex2DNode3 * temp_output_99_0 ) , _Glow_MultiplyWithDiffuse);
				float2 texCoord96 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				#endif
				float3 hdEmission130 = ASEGetEmissionHDRColor(( staticSwitch85 + float4( ( _FakeLighting_Night * temp_output_49_0 ) , 0.0 ) ).rgb,1.0,0.0,GetInverseCurrentExposureMultiplier());
				
				float lerpResult69 = lerp( _Roughness_A , _Roughness_B , tex2DNode3.a);
				float clampResult70 = clamp( lerpResult69 , 0.0 , 1.0 );
				
				surfaceDescription.BaseColor = temp_output_49_0;
				surfaceDescription.Normal = BlendNormal( unpack65 , unpack64 );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = staticSwitch74;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = hdEmission130;
				surfaceDescription.Smoothness = ( 1.0 - clampResult70 );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float temp_output_1_0_g585 = _Diffuse_Detail_FadeDistance;
				float lerpResult38 = lerp( 1.0 , 0.0 , saturate( ( ( distance( _WorldSpaceCameraPos , ase_worldPos ) - temp_output_1_0_g585 ) / ( 0.0 - temp_output_1_0_g585 ) ) ));
				float2 texCoord19 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_cast_2 = (tex2D( _Diffuse_Detail, ( texCoord19 * 8.0 ) ).g).xxxx;
				float2 temp_cast_3 = (_Diffuse_Detail_WS_Scale).xx;
				float3 ase_worldNormal = packedInput.ase_texcoord4.xyz;
				float4 triplanar25 = TriplanarSampling25( _Diffuse_Detail, ase_worldPos, ase_worldNormal, 1.0, temp_cast_3, 1.0, 0 );
				#ifdef _DIFFUSE_DETAIL_IS_WORLDSPACE_ON
				float4 staticSwitch27 = triplanar25;
				#else
				float4 staticSwitch27 = temp_cast_2;
				...
				float3 Binormal8_g587 = ( ( packedInput.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				...
				float3 unpack65 = UnpackNormalScale( tex2D( _Normal, uv_Normal ), _Normal_Amount );
				unpack65.z = lerp( 1, unpack65.z, saturate(_Normal_Amount) );
				float2 texCoord60 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack64 = UnpackNormalScale( tex2D( _DetailNormal, ( _Detail_Normal_Scale * texCoord60 ) ), _Detail_Normal__Amount );
				unpack64.z = lerp( 1, unpack64.z, saturate(_Detail_Normal__Amount) );
				...
				float4 temp_output_99_0 = ( ( tex2DNode72.g * _GlowColor ) * ( ( _Glow_Min_Amount + ( ( ( ( tex2D( _GlowWave, appendResult1_g579 ).g * tex2D( _GlowWave, appendResult1_g578 ).g ) + tex2D( _GlowWave, appendResult1_g582 ).g ) * ( tex2D( _GlowWave, appendResult1_g581 ).g + tex2D( _GlowWave, appendResult1_g580 ).g ) ) + 0.0 ) ) * lerpResult104 ) );
				float4 lerpResult88 = lerp( temp_output_99_0 , ( tex2DNode3 * temp_output_99_0 ) , _Glow_MultiplyWithDiffuse);
				float2 texCoord96 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult92 = clamp( pow( texCoord96.x , _GradientPower ) , 0.0 , 1.0 );
				float lerpResult91 = lerp( 1.0 , 0.0 , clampResult92);
				float4 lerpResult87 = lerp( lerpResult88 , ( lerpResult88 * lerpResult91 ) , _Glow_GradientMultiply);
				#ifdef _METALGLOWSSS_ON
		...
		Pass
		{
						...
						)
			{
				...
				float temp_output_1_0_g585 = _Diffuse_Detail_FadeDistance;
				float lerpResult38 = lerp( 1.0 , 0.0 , saturate( ( ( distance( _WorldSpaceCameraPos , ase_worldPos ) - temp_output_1_0_g585 ) / ( 0.0 - temp_output_1_0_g585 ) ) ));
				float2 texCoord19 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_cast_2 = (tex2D( _Diffuse_Detail, ( texCoord19 * 8.0 ) ).g).xxxx;
				float2 temp_cast_3 = (_Diffuse_Detail_WS_Scale).xx;
				float4 triplanar25 = TriplanarSampling25( _Diffuse_Detail, ase_worldPos, normalWS, 1.0, temp_cast_3, 1.0, 0 );
				#ifdef _DIFFUSE_DETAIL_IS_WORLDSPACE_ON
				...
				float3 unpack65 = UnpackNormalScale( tex2D( _Normal, uv_Normal ), _Normal_Amount );
				unpack65.z = lerp( 1, unpack65.z, saturate(_Normal_Amount) );
				float2 texCoord60 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack64 = UnpackNormalScale( tex2D( _DetailNormal, ( _Detail_Normal_Scale * texCoord60 ) ), _Detail_Normal__Amount );
				unpack64.z = lerp( 1, unpack64.z, saturate(_Detail_Normal__Amount) );
				...
				float4 temp_output_99_0 = ( ( tex2DNode72.g * _GlowColor ) * ( ( _Glow_Min_Amount + ( ( ( ( tex2D( _GlowWave, appendResult1_g579 ).g * tex2D( _GlowWave, appendResult1_g578 ).g ) + tex2D( _GlowWave, appendResult1_g582 ).g ) * ( tex2D( _GlowWave, appendResult1_g581 ).g + tex2D( _GlowWave, appendResult1_g580 ).g ) ) + 0.0 ) ) * lerpResult104 ) );
				float4 lerpResult88 = lerp( temp_output_99_0 , ( tex2DNode3 * temp_output_99_0 ) , _Glow_MultiplyWithDiffuse);
				float2 texCoord96 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult92 = clamp( pow( texCoord96.x , _GradientPower ) , 0.0 , 1.0 );
				float lerpResult91 = lerp( 1.0 , 0.0 , clampResult92);
				float4 lerpResult87 = lerp( lerpResult88 , ( lerpResult88 * lerpResult91 ) , _Glow_GradientMultiply);
				#ifdef _METALGLOWSSS_ON
...
WireConnection;119;1;66;0
WireConnection;119;4;74;0
WireConnection;119;6;130;0
WireConnection;119;7;71;0
WireConnection;119;11;75;0
WireConnection;130;0;57;0
WireConnection;130;1;131;0
ASEEND*/
//CHKSM=622135591A29A1194E28ACFE739A7FEE130B808F