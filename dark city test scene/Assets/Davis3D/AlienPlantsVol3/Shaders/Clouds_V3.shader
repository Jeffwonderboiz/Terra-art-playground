...
Shader "Davis3D/AlienPlants_Vol3/Enviroment/Clouds_V3"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		_Contrast_A("Contrast_A", Float) = 0
		_Contrast_B("Contrast_B", Float) = 1
		_Glow("Glow", Float) = 0
		_Cloud_Color("Cloud_Color", Color) = (1,0.5215687,0.5137255,1)
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float lerpResult9 = lerp( _Contrast_A , _Contrast_B , tex2D( _Texture, uv_Texture ).g);
				float clampResult7 = clamp( lerpResult9 , 0.0 , 5.0 );
				float4 temp_cast_0 = (clampResult7).xxxx;
				float4 blendOpSrc37 = _Cloud_Color;
				float4 blendOpDest37 = temp_cast_0;
				...
				surfaceDescription.Color = temp_output_37_0.rgb;
				surfaceDescription.Emission = ( _Glow * temp_output_37_0 ).rgb;
				surfaceDescription.Alpha = clampResult7;
...
ASEEND*/
//CHKSM=717EE3F5E7D83F0DCDB8EF487BBF440A3971BD9E