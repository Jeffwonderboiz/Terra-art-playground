...
Shader "Davis3D/AlienPlants_Vol3/Enviroment/Stars"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		_DarkenPattern_Contrast("DarkenPattern_Contrast", Float) = 1
		_DarkenPattern_UVScale("DarkenPattern_UVScale", Float) = 1
		_MaskPanSpeed("MaskPanSpeed", Float) = 0.1
		_StarBrightness("StarBrightness", Float) = 0
		_StarTinyBrightness("StarTinyBrightness", Float) = 2
		_UVScale("UVScale", Float) = 1
		_UVScaleTiny("UVScaleTiny", Float) = 3
		_Noise("Noise", 2D) = "white" {}
		_StarsTexture("StarsTexture", 2D) = "white" {}
		_StarGlow("StarGlow", Color) = (1,1,1,1)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _StarGlow;
			float _DarkenPattern_Contrast;
			float _MaskPanSpeed;
			float _DarkenPattern_UVScale;
			float _UVScale;
			float _StarBrightness;
			float _UVScaleTiny;
			float _StarTinyBrightness;
					...
					)
			{
				...
				float temp_output_3_0_g2 = _DarkenPattern_Contrast;
				float temp_output_2_0_g1 = ( _TimeParameters.x * _MaskPanSpeed );
				float2 texCoord4 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner2 = ( temp_output_2_0_g1 * float2( 1,1 ) + texCoord4);
				float lerpResult7_g2 = lerp( ( 0.0 - temp_output_3_0_g2 ) , ( temp_output_3_0_g2 + 1.0 ) , tex2D( _Noise, ( panner2 * _DarkenPattern_UVScale ) ).g);
				float clampResult12_g2 = clamp( lerpResult7_g2 , 0.0 , 1.0 );
				float4 temp_output_22_0 = ( ( clampResult12_g2 * ( tex2D( _StarsTexture, ( texCoord4 * _UVScale ) ) * _StarBrightness ) ) + ( tex2D( _StarsTexture, ( texCoord4 * _UVScaleTiny ) ) * _StarTinyBrightness ) );
				float4 temp_output_27_0 = ( _StarGlow * temp_output_22_0 );
				float3 hdEmission37 = ASEGetEmissionHDRColor(temp_output_27_0.rgb,temp_output_27_0.r,0.0,GetInverseCurrentExposureMultiplier());
				
				surfaceDescription.Color = float3( 0.5, 0.5, 0.5 );
				surfaceDescription.Emission = hdEmission37;
				surfaceDescription.Alpha = temp_output_22_0.r;
		...
		Pass
		{
					...
					)
			{
				...
				float temp_output_3_0_g2 = _DarkenPattern_Contrast;
				float temp_output_2_0_g1 = ( _TimeParameters.x * _MaskPanSpeed );
				float2 texCoord4 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner2 = ( temp_output_2_0_g1 * float2( 1,1 ) + texCoord4);
				float lerpResult7_g2 = lerp( ( 0.0 - temp_output_3_0_g2 ) , ( temp_output_3_0_g2 + 1.0 ) , tex2D( _Noise, ( panner2 * _DarkenPattern_UVScale ) ).g);
				float clampResult12_g2 = clamp( lerpResult7_g2 , 0.0 , 1.0 );
				float4 temp_output_22_0 = ( ( clampResult12_g2 * ( tex2D( _StarsTexture, ( texCoord4 * _UVScale ) ) * _StarBrightness ) ) + ( tex2D( _StarsTexture, ( texCoord4 * _UVScaleTiny ) ) * _StarTinyBrightness ) );
		...
		Pass
		{
					...
					)
			{
				...
				float temp_output_3_0_g2 = _DarkenPattern_Contrast;
				float temp_output_2_0_g1 = ( _TimeParameters.x * _MaskPanSpeed );
				float2 texCoord4 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner2 = ( temp_output_2_0_g1 * float2( 1,1 ) + texCoord4);
				float lerpResult7_g2 = lerp( ( 0.0 - temp_output_3_0_g2 ) , ( temp_output_3_0_g2 + 1.0 ) , tex2D( _Noise, ( panner2 * _DarkenPattern_UVScale ) ).g);
				float clampResult12_g2 = clamp( lerpResult7_g2 , 0.0 , 1.0 );
				float4 temp_output_22_0 = ( ( clampResult12_g2 * ( tex2D( _StarsTexture, ( texCoord4 * _UVScale ) ) * _StarBrightness ) ) + ( tex2D( _StarsTexture, ( texCoord4 * _UVScaleTiny ) ) * _StarTinyBrightness ) );
...
ASEEND*/
//CHKSM=729FA2356A0D4AA139B090E690D3E7988A54384F